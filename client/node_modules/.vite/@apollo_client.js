      ...
      if (node.operation === "subscription") {
        ...
        if (subscriptionType) {
          ...
          if (fields.size > 1) {
            ...
            context.reportError(new GraphQLError(operationName2 != null ? `Subscription "${operationName2}" must select only one top level field.` : "Anonymous Subscription must select only one top level field.", extraFieldSelections));
          }
          for (const fieldNodes of fields.values()) {
            const field = fieldNodes[0];
            const fieldName = field.name.value;
            if (fieldName.startsWith("__")) {
              context.reportError(new GraphQLError(operationName2 != null ? `Subscription "${operationName2}" must not select an introspection top level field.` : "Anonymous Subscription must not select an introspection top level field.", fieldNodes));
            }
          }
        }
      }
    ...
    OperationDefinition(node) {
      ...
      if (operationName2) {
        if (knownOperationNames[operationName2.value]) {
          context.reportError(new GraphQLError(`There can be only one operation named "${operationName2.value}".`, [knownOperationNames[operationName2.value], operationName2]));
        } else {
...
function useQuery(query, options) {
  ...
  var _c = (0, import_react2.useState)(function() {
    ...
    if (!result3.loading && options) {
      if (result3.error) {
        (_a6 = options.onError) === null || _a6 === void 0 ? void 0 : _a6.call(options, result3.error);
      } else if (result3.data) {
        (_b2 = options.onCompleted) === null || _b2 === void 0 ? void 0 : _b2.call(options, result3.data);
      }
    }
    return result3;
  ...
  (0, import_react2.useEffect)(function() {
    ...
    if (nextResult) {
      ...
      if (!nextResult.loading && options) {
        if (nextResult.error) {
          (_a6 = options.onError) === null || _a6 === void 0 ? void 0 : _a6.call(options, nextResult.error);
  ...
  (0, import_react2.useEffect)(function() {
    ...
    function onNext() {
      ...
      setResult(ref.current.result = result3);
      if (!result3.loading) {
        (_b2 = (_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.onCompleted) === null || _b2 === void 0 ? void 0 : _b2.call(_a6, result3.data);
      }
    }
  ...
  var partial;
  _a5 = result2, partial = _a5.partial, result2 = __rest(_a5, ["partial"]);
  {
    if (partial && (options === null || options === void 0 ? void 0 : options.partialRefetch) && !result2.loading && (!result2.data || Object.keys(result2.data).length === 0) && obsQuery.options.fetchPolicy !== "cache-only") {
      result2 = __assign(__assign({}, result2), { loading: true, networkStatus: NetworkStatus.refetch });
      obsQuery.refetch();
    }
    if (context.renderPromises && (options === null || options === void 0 ? void 0 : options.ssr) !== false && !(options === null || options === void 0 ? void 0 : options.skip) && result2.loading) {
  ...
  return __assign(__assign(__assign({}, obsQueryFields), { variables: createWatchQueryOptions(query, options, defaultWatchQueryOptions).variables, client, called: true, previousData: ref.current.previousData }), result2);
}
function createWatchQueryOptions(query, options, defaultOptions2) {
  var _a5;
  if (options === void 0) {
    options = {};
  }
  ...
  if (defaultOptions2) {
    watchQueryOptions = mergeOptions(defaultOptions2, watchQueryOptions);
  }
  if (skip) {
    watchQueryOptions.fetchPolicy = "standby";
  } else if (((_a5 = watchQueryOptions.context) === null || _a5 === void 0 ? void 0 : _a5.renderPromises) && (watchQueryOptions.fetchPolicy === "network-only" || watchQueryOptions.fetchPolicy === "cache-and-network")) {
...
function useLazyQuery(query, options) {
  var _a5 = (0, import_react3.useState)({
    called: false
  }), execution = _a5[0], setExecution = _a5[1];
  var result2 = useQuery(query, __assign(__assign(__assign({}, options), execution.options), { fetchPolicy: execution.called ? options === null || options === void 0 ? void 0 : options.fetchPolicy : "standby", skip: void 0 }));
  if (!execution.called) {
    result2 = __assign(__assign({}, result2), { loading: false, data: void 0, error: void 0, called: false });
  }
  ...
  result2.error = result2.error || void 0;
  Object.assign(result2, eagerMethods);
  var execute3 = (0, import_react3.useCallback)(function(executeOptions) {
    setExecution({ called: true, options: executeOptions });
    var promise = result2.refetch(executeOptions === null || executeOptions === void 0 ? void 0 : executeOptions.variables).then(function(result1) {
      var result22 = __assign(__assign({}, result2), { data: result1.data, error: result1.error, called: true, loading: false });
      Object.assign(result22, eagerMethods);
      return result22;
    });
...
function useMutation(mutation, options) {
  ...
  var execute3 = (0, import_react4.useCallback)(function(executeOptions) {
    ...
    return client2.mutate(clientOptions).then(function(response) {
      ...
      (_a7 = baseOptions.onCompleted) === null || _a7 === void 0 ? void 0 : _a7.call(baseOptions, response.data);
      ...
      if (baseOptions.onError || clientOptions.onError) {
        (_a7 = baseOptions.onError) === null || _a7 === void 0 ? void 0 : _a7.call(baseOptions, error);
...
function useSubscription(subscription, options) {
  ...
  (0, import_react5.useEffect)(function() {
    ...
    if (options === null || options === void 0 ? void 0 : options.skip) {
      if (!(options === null || options === void 0 ? void 0 : options.skip) !== !((_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.skip)) {
        setResult({
          loading: false,
          data: void 0,
          error: void 0,
